    ...
    <div class="panel-body">
        ...
        <form action="{{ url('/workers'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="department_id" id="department_id" class="form-control" value="{{$model['department_id'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
                <label for="position_id" class="col-sm-3 control-label">Position Id</label>
                <div class="col-sm-2">
                    <input type="number" name="position_id" id="position_id" class="form-control" value="{{$model['position_id'] or ''}}">
                </div>
            </div>
                                                                                                                        <div class="form-group">
                <label for="adopted_at" class="col-sm-3 control-label">Adopted At</label>
                <div class="col-sm-6">
                    <input type="text" name="adopted_at" id="adopted_at" class="form-control" value="{{$model['adopted_at'] or ''}}">
                </div>
            </div>
